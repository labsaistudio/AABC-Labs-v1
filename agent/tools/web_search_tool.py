...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        <parameter name="query">what is AABC AI and what are they building?</parameter>
    ...
    @xml_schema(
        ...
        <parameter name="urls">https://www.aabc.ai/,https://github.com/aabc-ai/aabc</parameter>
        </invoke>
        </function_calls>
        '''
    )
